...
describe("rnaTranscription", () => {
  it("should return the expected RNA strand for a valid long DNA strand", () => {
    ...
    const actual = rnaTranscription("ACGTGGTCTTTAA");
  ...
  it("should return the error message for a invalid DNA strand conteining other letters", () => {
  ...
  it("should return the error message for a invalid DNA strand containing numers", () => {
    const expected = "Failed to retrieve RNA transcription: Invalid DNA strand";
